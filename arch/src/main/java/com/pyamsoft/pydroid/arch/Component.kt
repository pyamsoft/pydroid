...
internal object Internals {
  ...
  @PublishedApi
  internal inline fun <
      S : UiViewState, V : UiViewEvent, C : UiControllerEvent> performCreateComponent(
      savedInstanceState: Bundle?,
      owner: LifecycleOwner,
      controller: UiController<C>,
      views: Array<out UiView<S, out V>>,
      onCreateComponent:
          CoroutineScope.(UiController<C>, UiSavedStateReader, Array<out UiView<S, out V>>) -> Unit,
  ): StateSaver {
...
public inline fun <S : UiViewState, V : UiViewEvent, C : UiControllerEvent> createComponent(
  ...
  return Internals.performCreateComponent(savedInstanceState, owner, controller, views) {
      uiController,
      reader,
      uiViews ->
