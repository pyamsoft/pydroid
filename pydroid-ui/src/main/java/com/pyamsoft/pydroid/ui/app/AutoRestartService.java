...
public abstract class AutoRestartService extends Service {
  ...
  @Override public void onTaskRemoved(Intent rootIntent) {
    ...
    if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT && isAutoRestartEnabled()) {
      Timber.w("Android KitKat is affected by a bug which causing START_STICKY "
      ...
      PendingIntent pendingIntent =
          PendingIntent.getService(getApplicationContext(), 1024, restartIntent,
      ...
      // Schedule alarm
      long restartTime = SystemClock.elapsedRealtime() + TimeUnit.SECONDS.toMillis(5);
   ...
   */
  @CheckResult protected boolean isAutoRestartEnabled() {
    return true;
  }
}
