...
package com.pyamsoft.pydroidui.about;
...
import com.pyamsoft.pydroidui.databinding.AdapterItemAboutBinding;
import java.lang.ref.WeakReference;
import java.util.List;
import timber.log.Timber;

class AboutAdapterItem
    extends GenericAbstractItem<AboutLicenseModel, AboutAdapterItem, AboutAdapterItem.ViewHolder> {
