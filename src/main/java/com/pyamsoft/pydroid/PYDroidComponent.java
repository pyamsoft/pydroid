...
import com.pyamsoft.pydroid.ads.AdvertisementComponent;
import com.pyamsoft.pydroid.social.SocialMediaComponent;
import com.pyamsoft.pydroid.support.SupportComponent;
...
@Singleton @Component(modules = PYDroidModule.class) interface PYDroidComponent {
  ...
  AdvertisementComponent plusAdvertisementComponent();
