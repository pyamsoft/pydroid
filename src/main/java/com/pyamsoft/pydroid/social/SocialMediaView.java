...
public class SocialMediaView extends FrameLayout implements SocialMediaPresenter.View {
  ...
  @NonNull private static final String KEY_PRESENER = "key_social_presenter";
  ...
  private void init(@NonNull Context context) {
    ...
    loadedKey = PersistentCache.get().load(KEY_PRESENER, null, new SocialMediaLoaderCallback() {
