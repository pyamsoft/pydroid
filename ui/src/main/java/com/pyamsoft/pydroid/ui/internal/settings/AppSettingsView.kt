...
internal constructor(
  ...
  private fun Preference.adjustTint(darkTheme: Boolean) {
    ...
    if (icon != null) {
      this.icon =
          icon.tintWith(
              ContextCompat.getColor(context, if (darkTheme) R.color.white else R.color.black))
    }
  }

  private fun setupDonate() {
    donate.onPreferenceClickListener =
  ...
  private fun setupViewSource() {
    ...
    viewSource.onPreferenceClickListener =
        Preference.OnPreferenceClickListener {
  ...
  private fun setupMoreApps() {
    moreApps.onPreferenceClickListener =
        Preference.OnPreferenceClickListener {
  ...
  private fun setupSocial() {
    ...
    social.onPreferenceClickListener =
        Preference.OnPreferenceClickListener {
  ...
  private fun setupBlog() {
    ...
    followBlog.onPreferenceClickListener =
        Preference.OnPreferenceClickListener {
  ...
  private fun setupRateApp() {
    rate.onPreferenceClickListener =
        Preference.OnPreferenceClickListener {
  ...
  private fun setupBugReport() {
    ...
    bugReport.onPreferenceClickListener =
        Preference.OnPreferenceClickListener {
  ...
  private fun setupLicenses() {
    licenses.onPreferenceClickListener =
        Preference.OnPreferenceClickListener {
  ...
  private fun setupClearAppData() {
    if (hideClearAll) {
      ...
      clearAll.onPreferenceClickListener =
          Preference.OnPreferenceClickListener {
  ...
  private fun setupShowUpgradeInfo() {
    if (hideUpgradeInformation) {
      ...
      upgradeInfo.onPreferenceClickListener =
          Preference.OnPreferenceClickListener {
